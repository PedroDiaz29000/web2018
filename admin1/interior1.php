...
<div id="cuerpo">
  ...
  <div id="publi">
    ...
    <div id="aviso"><a href="../feria/view/index.php" target="_blank"><img src="imagenes/publi_whatsapp.jpg" width="285" height="400" alt="aviso"></a>
    </div>
...
$rescat=ucfirst($te4);
  ...
  <div class="actividad_detalle">
		...
		<?php echo $detalle; ?>
        <hr>
	   Participa y colabora, si observas una situación similar en nuestro distrito envíanos tu denuncia o reporte a través de  <strong>WhatsApp Carabayllo</strong> al número <strong>981-398-520.</strong></div>
       <div class="barrita_naranja">
       </div>
	</div>
	...
	<div id= "centro">
		...
		<?php 
		$tambien="select top 2 n.id,n.idpersona,n.titulo,n.detalle,n.fecha,d.rutafoto,n.categoria from noticia n, detalle d where n.estado =1 and n.id=d.noticia and n.id NOT IN ('$codigo') and n.categoria='$categoriav' and d.estado_foto=1 order by calificacion desc";
		//echo $tambien;
